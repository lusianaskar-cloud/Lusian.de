  ...
  return (
    <>
      <Section tone="light" className="relative overflow-hidden bg-ivory">
        <LitGround preset="plaster" still={0.4} dim={0.4} />
        <Container className="pb-16 pt-36 lg:pb-24 lg:pt-44">
          <Reveal eager>
            <Eyebrow>{copy.eyebrow}</Eyebrow>
          </Reveal>
          <h1 className="mt-10 max-w-[16ch] lg:mt-14 type-structure text-[calc(clamp(2.3rem,6vw,5rem)*var(--ar-struct))]">
            ...
            <Reveal key={category.id} wide>
              <section className="grid gap-8 border-t border-ink/12 py-12 lg:grid-cols-12 lg:gap-10 lg:py-16">
                <div className="lg:col-span-4 lg:sticky lg:top-32 lg:self-start">
                  ...
                  <h2 className="mt-4 type-structure text-[calc(clamp(1.4rem,2.4vw,1.9rem)*var(--ar-struct))]">
                    {category.title}
                  </h2>
                </div>
                ...
                <div className="lg:col-span-7 lg:col-start-6">
                  {category.questions.map((item) => (
                    ...
                    >
                      ...
                      <p className="max-w-xl pb-6 type-voice text-[0.9375rem] text-tone-muted">
                        {item.a}
                      </p>
                    </details>
                  ))}
